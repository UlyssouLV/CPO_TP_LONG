...
public class GrilleDeCellules {
    ...
    */ 
     ...
     * <p>
     * A la construction d'une grille de Cellules, le nombre de lignes est fixé à GrilleDeCellules#p_nbLignes
     * le nombre de colonnes est fixé à GrilleDeCellules#p_nbColonnes
     * la matrice de la grille de cellules est initialisée avec une taille GrilleDeCellules#p_nbLignes x GrilleDeCellules#p_nbColonnes
     ...
     * Ce choix aléatoire dépend de activerLigneColonnesOuDiagonalesAleatoire#loc
     ...
     * au numéro activerLigneColonnesOuDiagonalesAleatoire#lr et activerLigneColonnesOuDiagonalesAleatoire#cr
